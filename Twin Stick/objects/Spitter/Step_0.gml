...
//sprite_set_bbox(sprite_index,35,104,88,126)
sprite_set_bbox(sprite_index,0,0,0,0)
...
//{
//	while !collision_present(x+sign(hsp+hsp_knockback),y){x += sign(hsp+hsp_knockback)}
//	hsp = 0
//	hsp_knockback = 0
//}
