...
glitch_noise = 0//clamp(glitch_intensity,0,0.5)
if !audio_is_playing(sfx_CameraStatic){
glitch_sound = audio_play_sound(sfx_CameraStatic,5,true)}
if glitch_intensity >= 0.9{audio_sound_gain(glitch_sound,glitch_noise,0)}
else{
audio_sound_gain(glitch_sound,glitch_noise,220)}
