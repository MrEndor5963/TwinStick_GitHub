...
key_back = gamepad_button_check_pressed_any(gp_face2) or keyboard_check_pressed(vk_escape) or keyboard_check_pressed(vk_backspace) or keyboard_check_pressed(ord("X"))
