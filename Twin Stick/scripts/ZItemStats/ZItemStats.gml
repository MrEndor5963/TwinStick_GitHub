...
cost = 500
description_text = "Earn an extra $1 per bullet hit enemy"
if object_index = GM{
array_push(item_list,item_sprite)
exit}
if object_index = Player && new_item != -1{
...
cost = 1500
description_text = "Once per floor, get your money back after using the mystery box"
if object_index = GM{
array_push(item_list,item_sprite)
exit}
if object_index = Player && new_item != -1{
...
item_name = "Ammo Case"
cost = 2100
description_text = "All wall guns come with an extra 50% reserve ammo upon purchase"
if object_index = GM{
array_push(item_list,item_sprite)
exit}
if object_index = Player && new_item != -1{
